...
import App from '../../App'
import { Animation, Main } from './styles'
...
export default function Loader() {
    ...
    return (
        <div data-testid={'animation-svg'}>
            {!done ? (
                <Main>
                    <Animation >
                        <svg id="favourite" enable-background="new 0 0 300 300" height="512" viewBox="0 0 300 300" width="512" xmlns="http://www.w3.org/2000/svg" >
                            <g>
